...
if (isset($_GET["action"])) {
    ...
    $redirect = isset($_POST["redirect"]) ? urldecode($_POST["redirect"]) : "personal_reviews.php";
    ...
    switch($_POST["action"]) {
        case "C":
            if (isset($_POST["canteen_id"])) {
                ...
                if ($exitCode == 0) {
                    header("Location: $redirect&action=C&success=1");
                    exit();
                } else {
        ...
        case "U":
            if (isset($_POST["review_id"])) {
                ...
                if ($exitCode == 0) {
                    header("Location: $redirect&action=U&success=1");
                    exit();
                } else {
        ...
        case "D":
            if (isset($_POST["review_id"])) {
                ...
                header("Location: $redirect?&action=D&success=1");
                exit();
            } else {
                header("Location: explore.php");
                exit();
