        ...
        <div class="row justify-content-center px-3">
            ...
            <article class="card col-10 mb-2">
                <div class="card-body">
                    ...
                    <div class="my-2">
                        <a class="btn btn-outline-primary btn-sm" href="process_review.php?action=U&id=<?php echo $r->getId(); ?>"><span class="bi bi-pen-fill"></span></a>
                        <!--Pulsante Modal-->
                        <button type="button" title="elimina" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#remove-confirm-<?php echo $r->getId(); ?>"><span class="bi bi-trash-fill"></span></button>

                        <!-- Modal -->
                        <div class="modal fade" id="remove-confirm-<?php echo $r->getId(); ?>" data-bs-keyboard="false" tabindex="-1" aria-labelledby="removeConfirmLabel-<?php echo $r->getId(); ?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="removeConfirmLabel-<?php echo $r->getId(); ?>">Conferma rimozione</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Sei sicuro di voler eliminare la tua recensione di titolo <strong><?php echo $r->getTitle(); ?></strong>?</p>
                                    </div>
