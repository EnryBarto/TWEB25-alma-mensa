...
L'amministratore del sistema è una tipologia speciale di utente, che può registrare \textbf{nuove mense} al sistema e crearne l'account di gestione (vedi \cref{sub:GestoreMensa}).
...
\\
Tramite la propria area una mensa potrà pubblicare i \textbf{menu giornalieri}, visualizzare le \textbf{prenotazioni} e registrare le \textbf{presenze} degli usufruitori.
